...
8.LaTeX failed to compile _main.tex. See https://yihui.org/tinytex/r/#debugging for debugging tips.

Use MikTex instead of TinyTex.


9.Error:Fonts inconsola and Andale Mono not found

 Install font "inconsola" and "Andale Mono".then put it in C:\Windows\Fonts.


10.Error: File `xeCJK.sty' not found

 Install the package in MikTex console.
